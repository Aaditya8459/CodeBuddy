...
export default function Home() {
  return (
    <div className="relative min-h-screen flex flex-col bg-[#0a0a0a] overflow-auto">
      <Background />
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        {/* Center Content */}
        <main className="flex-1 flex flex-col items-center justify-start px-6 py-12 md:justify-center">
