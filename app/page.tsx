      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <header className="flex items-center justify-between px-6 py-5 md:px-12">
          <div className="flex items-center gap-3 cursor-pointer hover:scale-[1.02] transition-transform">
            {/* Gradient Logo Block */}
            <div className="w-12 h-12 rounded-[14px] bg-gradient-to-br from-[#f04600] via-[#fa8c00] to-[#faa000] flex items-center justify-center shadow-lg shadow-orange-500/30 relative overflow-hidden">
              <div className="absolute inset-[1px] rounded-[12px] bg-gradient-to-br from-[#f04600] via-[#fa8c00] to-[#faa000]" />
        ...
        <main className="flex-1 flex items-center justify-center px-6 py-12">
          <div className="w-full max-w-md">
            ...
            <div className="flex flex-col items-center mb-8">
              {/* Gradient Logo Block */}
              <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-[#f04600] via-[#fa8c00] to-[#faa000] flex items-center justify-center shadow-xl shadow-orange-500/20 mb-4 relative overflow-hidden">
                <div className="absolute inset-[2px] rounded-[18px] bg-gradient-to-br from-[#f04600] via-[#fa8c00] to-[#faa000]" />
                <div className="relative z-10">
              ...
              <h1 className="font-space text-3xl md:text-4xl font-bold text-white text-center">
                Welcome to{" "}
                <span className="bg-gradient-to-r from-[#f04600] via-[#fa8c00] to-[#faa000] bg-clip-text text-transparent">
                  Code Buddy
                </span>
              </h1>
